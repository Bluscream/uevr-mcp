...
// Ranges tuned for UE4.22–UE5.5. UE5 adds 8 bytes to FProperty base via
// FFieldClass pointer + FFieldVariant, pushing subclass fields up a slot.
static const int32_t kShortRange[]  = { 0x40, 0x48, 0x50, 0x58, 0x60, 0x68, 0x70, 0x78, 0x80, 0x88, 0x90, 0x98, 0xA0 };
static const int32_t kFieldRange[]  = { 0x40, 0x48, 0x50, 0x58, 0x60, 0x68, 0x70, 0x78, 0x80, 0x88, 0x90, 0x98, 0xA0, 0xA8, 0xB0 };
...
// UClass offset search range. UE4.22–UE5.5 ClassWithin sits between ~0xA0
// and 0x160 depending on alignment + bitpacking of earlier fields. UE5
// widened earlier UClass bitpack (ClassReps, bCooked, SparseClassDataStruct,
// FNetCache, etc.) which pushes ClassWithin to the high end of this range.
static const int32_t kUClassRange[] = {
    ...
    0x138, 0x140, 0x148, 0x150, 0x158, 0x160
};
